...
/*handleSubmit function to link html validation together
 with custome calculateCalorie() function*/
...
function calculateCalorie() {
    ...
    let bmr;
    let calorieNeeds;
    /*Harris-Benedict Equation is used to Calculate BMR,
    chatGPT was used to come up with the equation and
    helped with the code structure.*/
    if (gender === "male") {
    ...
    let hideDiv = document.getElementById("calorie-default");
    hideDiv.style.display = "none";

    let resultDiv = document.getElementById("calorie-result");
...
reset.addEventListener("click", function () {
    ...
    let defaultDiv = document.getElementById("calorie-default");
